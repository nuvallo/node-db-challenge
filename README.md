...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      Relational Databases is a type of database as SQL is a structured query language, which is the language to retrieve data from the database and manuplate it.

- [x] Why do tables need a `primary key`?
      Allows relationships to establish between tables
